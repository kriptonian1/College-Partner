  ...
  return (
    <div>
      ...
      <div className='mx-[35vw]'>
        ...
        <button className="focus:shadow-lg hover:shadow-lg py-3.5 px-4 rounded-full bg-[#1877F2] flex justify-center items-center w-full mt-10">
